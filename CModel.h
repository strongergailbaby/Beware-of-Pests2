...
public:
    ...
    void            reset(int32_t width, int32_t height, int32_t pestsNumber);
    ...
    uint8_t         getPests(int32_t x, int32_t y) const;
...
private:
    void            populatePestsCrew(int32_t xToSkip, int32_t yToSkip);
    void            populateNeighbourhood();
    bool            isValidIndex(int32_t x, int32_t y) const;

    int32_t             m_width;
    int32_t             m_height;
    int32_t             m_totalPestsNr;
